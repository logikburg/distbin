...
function parallax() {
    function a() {
        ...
        function g(a) {
            G.Sa === !0 && (a.preventDefault && a.preventDefault(), v = a.vorw ? -a.deltaY / 4 : 1 == a.deltaMode ? -a.deltaY / 3 : 100 === Math.abs(a.deltaY) ? -a.deltaY / 120 : -a.deltaY / 40, v = -y > v ? -y : v, v = v > y ? y : v, s = !0, u = z)
        }
        ...
        jQuery(document).ready(function() {
            ...
            return q = Math.max(document.documentElement.clientHeight, window.innerHeight || 0), /Android|iPad|iPhone|iPod|BlackBerry|Windows Phone|Edge|Version\/[\d\.]+.*Safari/i.test(navigator.userAgent || navigator.vendor || window.opera) ? jQuery(".parallax") : l && (G.vope(), G.vops()), h(a) ? void a() : void 0
        }, this.windowLoad = function() {
            q = Math.max(document.documentElement.clientHeight, window.innerHeight || 0), r = j(), window.Parallax.vope()
        }, this.vops = function() {
            ...
            k = [], r = j();
            var a = i(),
                b = ".parallax > .background-image, .home-slider div.slide .background-image";
            a && (b = ".home-slider div.slide .background-image"), jQuery(b).each(function(b) {
                ...
                }), a ? a && (c.is(":nth-of-type(1)") ? G.tt(jQuery(this).get(0), 0 === e() ? 0 : e() / 2) : G.tt(jQuery(this).get(0), (e() - d - r) / 2)) : c.is(":nth-of-type(1)") ? G.tt(jQuery(this).get(0), 0 === e() ? 0 : e() / 2) : G.tt(jQuery(this).get(0), (e() + q - d) / 2)
            })
        }, this.tt = function(a) {
            a.style[n] = o + j + p
        }
    }
    window.Parallax = new a,
        function(a, b) {
            function c(b, c, g, h) {
...
function GoogleMaps() {
    function g(b, e) {
        var f = new google.maps.LatLng(b, e),
            ...
            h = new google.maps.Map(document.getElementById("content-map"), g),
            i = '<div class="content-map-info">' + c + "</div>",
        ...
        if ("light" === a.data("map-style")) var n = new google.maps.StyledMapType(l);
        else if ("dark" === a.data("map-style")) var n = new google.maps.StyledMapType(m);
...
function initMaps() {
    var a = $("#content-map").data("maps-api-key"),
        b = document.createElement("script");
    b.src = "https://maps.googleapis.com/maps/api/js?key=" + a + "&callback=GoogleMaps", document.body.appendChild(b)
}
